...
class point_cloud2_t(object):
    ...
    __typenames__ = ["int32_t", "int32_t", "int64_t", "eigen.types.generated.point_field_t", "boolean", "int32_t", "int32_t", "int64_t", "int32_t", "boolean"]
    ...
    def __init__(self):
        ...
        """ LCM Type: int64_t """
        self.fields = []
        """ LCM Type: eigen.types.generated.point_field_t[num_fields] """
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_fields):
            assert self.fields[i0]._get_packed_fingerprint() == eigen.types.generated.point_field_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.fields = []
        for i0 in range(self.num_fields):
            self.fields.append(eigen.types.generated.point_field_t._decode_one(buf))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xa9a372e129fdd8c4+ eigen.types.generated.point_field_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
