...
class node_info_t(object):
    ...
    __typenames__ = ["string", "string", "eigen.types.generated.comms_info_t"]
    ...
    def __init__(self):
        ...
        self.node_id = ""
        """ LCM Type: string """
        self.comms = eigen.types.generated.comms_info_t()
        """ LCM Type: eigen.types.generated.comms_info_t """
    ...
    def _encode_one(self, buf):
        ...
        buf.write(b"\0")
        assert self.comms._get_packed_fingerprint() == eigen.types.generated.comms_info_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.comms = eigen.types.generated.comms_info_t._decode_one(buf)
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x2935a5062337a0ca+ eigen.types.generated.comms_info_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
