...
class network_info_t(object):
    ...
    __typenames__ = ["int64_t", "ark.types.generated.node_info_t"]
    ...
    def __init__(self):
        ...
        LCM Type: ark.types.generated.node_info_t[n_nodes]
        """
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.n_nodes):
            assert self.nodes[i0]._get_packed_fingerprint() == ark.types.generated.node_info_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.nodes = []
        for i0 in range(self.n_nodes):
            self.nodes.append(ark.types.generated.node_info_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xd5253b1d636e7b28+ ark.types.generated.node_info_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
