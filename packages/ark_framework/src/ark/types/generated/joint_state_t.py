...
class joint_state_t(object):
    ...
    __typenames__ = ["ark.types.generated.header_t", "int64_t", "string", "double", "double", "double"]

    __dimensions__ = [None, None, ["n"], ["n"], ["n"], ["n"]]

    def __init__(self):
        self.header = ark.types.generated.header_t()
        """ LCM Type: ark.types.generated.header_t """
        self.n = 0
        """ LCM Type: int64_t """
        self.name = []
        """ LCM Type: string[n] """
    ...
    def _encode_one(self, buf):
        assert self.header._get_packed_fingerprint() == ark.types.generated.header_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        self = joint_state_t()
        self.header = ark.types.generated.header_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x5cf141922785539d+ ark.types.generated.header_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
