...
from ark.core.system.component_registry import list_components
...
def _discover_and_import_components(debug: bool = False):
    """Discover and import all available ark component modules."""
    # List of ark packages that might contain components
    ark_packages = ["ark.robots", "ark.sensors", "ark.objects"]

    for package_name in ark_packages:
        try:
