Here’s a concise, developer-friendly **README.md** you can drop right next to your generator script (`lcm_gen.py`):

---

# 🧩 Lightweight LCM → Python Generator

A minimal, **pure-Python re-implementation** of `lcm-gen` that converts `.lcm` message definitions into **Python classes** — without requiring the full LCM toolchain or any non-stdlib dependencies.
...
### 1️⃣  Create your `.lcm` definition(s)
...
### 3️⃣  (Optional) Flat output

If your package folders (e.g. `eigen/types/generated/`) already exist and you **don’t** want the generator to recreate subfolders, run:
