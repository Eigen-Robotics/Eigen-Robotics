...
class image_array_t(object):
    ...
    __typenames__ = ["int64_t", "int32_t", "eigen.types.image_t"]
    ...
    def __init__(self):
        ...
        """
        An array of image_t.
        LCM Type: eigen.types.image_t[num_images]
        """
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_images):
            assert self.images[i0]._get_packed_fingerprint() == eigen.types.image_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.images = []
        for i0 in range(self.num_images):
            self.images.append(eigen.types.image_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x7fbb3284dcdd82df+ eigen.types.image_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
