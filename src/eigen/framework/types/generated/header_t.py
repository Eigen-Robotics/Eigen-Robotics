...
class header_t(object):
    ...
    __typenames__ = ["int64_t", "eigen.types.stamp_t", "string"]
    ...
    def __init__(self):
        self.seq = 0
        """ LCM Type: int64_t """
        self.stamp = eigen.types.stamp_t()
        """ LCM Type: eigen.types.stamp_t """
        self.frame_id = ""
        """ LCM Type: string """
    ...
    def _encode_one(self, buf):
        ...
        assert self.stamp._get_packed_fingerprint() == eigen.types.stamp_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.stamp = eigen.types.stamp_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xdbb33f435c19b8ea+ eigen.types.stamp_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
