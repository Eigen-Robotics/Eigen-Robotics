...
class bullet_dynamics_t(object):
    ...
    __typenames__ = ["int32_t", "int32_t", "float", "float", "float", "float", "float", "float", "float", "float", "float", "int32_t", "eigen.types.float_vector_t", "float", "float", "int32_t", "float", "float", "float", "float", "float", "float", "float", "int32_t"]
    ...
    def __init__(self):
        ...
        self.localInertiaDiagonal = eigen.types.float_vector_t()
        """
    ...
    def _encode_one(self, buf):
        ...
        assert self.localInertiaDiagonal._get_packed_fingerprint() == eigen.types.float_vector_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.localInertiaDiagonal = eigen.types.float_vector_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xb3c94a72a1477368+ eigen.types.float_vector_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
